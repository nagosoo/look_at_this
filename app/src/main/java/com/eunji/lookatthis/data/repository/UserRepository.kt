...
interface UserRepository {
    ...
    fun postSignUp(postUserAccountReqModel: PostUserAccountReqModel): Flow<UiState<String?>>
    fun postSignIn(postUserAccountReqModel: PostUserAccountReqModel): Flow<UiState<String?>>
